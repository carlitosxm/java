...
public class TestInsertarRegistro {
	...
	public static void main(String[] args) {
		...
		try {
			...
			em.setFecha(fecha);
			em.setHora(hora);
			RegistrosEntrada re=new RegistrosEntrada(99, "1234561231", Convertidor.convertirFecha("2000/12/13"), Convertidor.convertirHora("09:23"), em);
